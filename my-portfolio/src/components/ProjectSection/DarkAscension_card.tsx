        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
          ...
          <div className="flex-1 flex flex-col gap-6">
            <p className="text-white text-lg font-sans leading-relaxed">
              Being very passionate about World of Warcraft, I decided to make a
              guide for the Shadow Priest specialization because I couldn't find
              any specific websites with a guide. The website includes detailed
              guides on both hero talents, consumables, rotation, as well as a
              discussion page and a WoWHead news page that automatically updates
              hourly.
            </p>
            ...
            <div className="inline-flex flex-wrap gap-4 p-4 bg-zinc-800 rounded-full shadow-[0_0_15px_grey] w-fit self-start">
              ...
              />
              <img
                src="/portfolio/assets/imgs/django.svg"
                alt="Django"
                className="w-10 h-10"
              />
              <img
                src="/portfolio/assets/imgs/postgre.svg"
                alt="PostgreSQL"
                className="w-10 h-10"
              />
            </div>
